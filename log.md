...
**Thoughts** I've solved with referencing the discussion as below. Then I understand the algorithm with drawing a figure which represents running processes.
